window._wpemojiSettings = {
  ...
  source: {
    concatemoji:
      "https://cvio.bslthemes.com/v3/wp-includes/js/wp-emoji-release.min.js?ver=5.6.1",
  },
};
!(function (e, a, t) {
  var n,
...
var wpcf7 = {
  apiSettings: {
    root: "https://cvio.bslthemes.com/v3/wp-json/contact-form-7/v1",
...
(function ($) {
  ...
  $(function () {
    ...
    $("div.contactForm > form").each(function () {
      var $form = $(this);
      wpcf7.initForm($form);
      if (wpcf7.cached) {
        wpcf7.refill($form);
        ...
        case "validation_failed":
          $.each(data.invalid_fields, function (i, n) {
            $(n.into, $form).each(function () {
              ...
              $(".form-control", this).addClass("wpcf7-not-valid");
              $(".form-control", this).attr(
                "aria-describedby",
                n.error_id
              );
  ...
  wpcf7.clearResponse = function (form) {
    ...
    $(".form-control", $form).removeClass("wpcf7-not-valid");
    $(".response-output", $form).hide().empty();
  };
...
jQuery(document).ready(function ($) {
  $(".social-share").rrssb({
    ...
    url: "https://cvio.bslthemes.com/v3/portfolio-archive/curved-ceiling-ribs/",
  });
});
(function ($) {
  "use strict";
...
(function ($) {
  ...
  $(window).on("load", function () {
    ...
    if ($(".reviews-carousel").length) {
      ...
      var rev_slider = new Swiper(".reviews-carousel .swiper-container", {
        ...
        breakpoints: {
          720: { slidesPerView: 1, spaceBetween: is_spacebetween },
          1200: { slidesPerView: is_slidesview, spaceBetween: is_spacebetween },
        },
      });
    }
    if ($(".team-carousel").length) {
      ...
      var team_slider = new Swiper(".team-carousel .swiper-container", {
        ...
        breakpoints: {
          720: { slidesPerView: 1, spaceBetween: t_is_spacebetween },
          1200: {
            slidesPerView: t_is_slidesview,
            spaceBetween: t_is_spacebetween,
          },
  ...
  $container.imagesLoaded(function () {
    ...
    if ($(".portfolio-items.portfolio-new").length) {
      var s_parallax = document.getElementsByClassName("postImg");
